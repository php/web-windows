  ...
  <ul id="content-columns">
    ...
    <li id="main-column">
      ...
      <?php news_date('04-Jun-2019') ?>
			<div>
			<p>All binary packages we were offering contained "vc#" (for instance, "vc14") in the filename to designate
      ...
      <?php news_date('26-Dec-2018') ?>
			<div>
			<p>The recent release candidates 7.2.14RC1 and 7.3.1RC1 use the latest OpenSSL 1.1.1 release branch.
				Please help testing these release candidates with the regard to the OpenSSL compatibility and report bugs.
				This concerns the OpenSSL extension itself as well as the extensions depending on OpenSSL like cURL.
			</p>
			</div>
		  </div><!-- .info -->
 		  ...
 		  <div class="info entry">
			<!-- .info -->
			<h3 class="summary entry-title">The windows.php.net site uses SSL by default</h3>
      <?php news_date('12-Mar-2018') ?>
			<div>
			<p>Thanks to &quot;Let's Encrypt&quot;, the site now uses SSL by default. All the non
				SSL links are transparently redirected to the SSL locations.
			</p>
			<p>WinXP users might experience connection issues. It is a high time to switch away
      ...
      <?php news_date('08-Mar-2018') ?>
			<div>
			<p>In addition to the usual regular snapshots, the current master builds deliver binaries with 
			<a href="https://en.wikipedia.org/wiki/Advanced_Vector_Extensions">AVX (Advanced Vector Extensions)</a> support.
			AVX is an instruction set available in many modern CPUs. The internal PHP implementation uses these
			specific CPU instructions to improve performance.
			</p>

			<p>Processors, manufactured after 2011, most likely support AVX. The exact information about the
			hardware can be retrieved by using the <a href="https://docs.microsoft.com/en-us/sysinternals/downloads/coreinfo">Coreinfo</a> tool.</p>
