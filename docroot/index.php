...
?>
				...
				<div class="content">
				    ...
				    <div class="block"><!-- .block -->
				      ...
				      <h3 class="summary entry-title">PHP 5.3.6 Released!</h3>
				      <p class="news-date"><abbr class="published newsdate" title="2011-03-17T13:43:21+00:00">[17-Mar-2011]</abbr>
     ...
     <a href="http://www.php.net/ChangeLog-5.php#5.3.6">ChangeLog</a>. For source and binaries downloads
     please visit our <a href="/download/">downloads page</a>.</p>
    </div>
					</div><!-- .info -->
				    ...
				    <div class="block"><!-- .block -->
				      ...
				      <div class="info entry"><!-- .info -->
				      <h3 class="summary entry-title">PHP 5.3.2 released</h3>
				      <p class="news-date"><abbr class="published newsdate" title="2010-03-04T19:00:11+00:00">04-Mar-2010</abbr></p>
				      <div class="newsImage"></div>
				      <div>
				      <p>
				      ...
				      <p>The SNMP extension is now available in VC9 versions. The cURL and MPIR libraries have been updated.</p>
				      <p>
					...
					<div class="info entry"><!-- .info -->
						<h3 class="summary entry-title">PHP 5.2.13 released</h3>
						<p class="news-date"><abbr class="published newsdate" title="2010-02-25T17:00:11+00:00">25-Feb-2010</abbr></p>
						<div class="newsImage"></div>
						<div>
						<p>The PHP development team would like to announce the immediate
					...
					<div class="info entry"><!-- .info -->
						<h3 class="summary entry-title">PHP 5.3.1 released</h3>
						<p class="news-date"><abbr class="published newsdate" title="2009-11-19T17:41:11+00:00">19-Nov-2009</abbr></p>
						<div class="newsImage"></div>
						<div>
							<p>The PHP development team would like to announce the immediate
							...
							<p>The OpenSSL library has been updated to 0.9.8l, which fixes important bugs fixes (see the OpenSSL <a href="">website</a> for details.</p>
					...
					<div class="info entry"><!-- .info -->
						...
						<p class="news-date"><abbr class="published newsdate" title="2009-09-17T14:00:00+02:00">17-Sept-2009</abbr></p>
						<div class="newsImage"></div>
						<div>
							<p>
