...
$releases = buildSnapsCache(SNAPS_DIR);
?>
<?php
...
$releases = processSnapsDirectory(SNAPS_DIR);
...
foreach ($release_order as $point_version) {
    echo buildPointVersionBox($point_version, $releases[$point_version], $version_order);
}
?>
